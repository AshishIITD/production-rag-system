...
print(f"Loading BGE-M3 Embeddings...")
    ...
    if os.path.exists(VECTOR_STORE_DIR):
        ...
        if not os.path.exists(sample_kb_path):
            with open(sample_kb_path, "w") as f:
                ...
                f.write("BGE-M3 is a state-of-the-art multilingual embedding model by BAAI.\n")
...
async def query_rag(request: QueryRequest):
    ...
    return QueryResponse(answer=answer, contexts=contexts, latency_ms=latency)
